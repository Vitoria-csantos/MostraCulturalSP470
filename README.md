...
### Código 
<p> Alguns códigos tiveram problema em carregar no GitHub, então aqui estão eles. </p>


#### Troca de cena

<p>public class colission : MonoBehaviour
{
...
<p>public class movPerso : MonoBehaviour
{ 
    Vector3 m;
...
#### Troca de cor
<p>public class trocarecCorr : MonoBehaviour
{
